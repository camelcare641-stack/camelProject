...
export const modal = {
  ...
  bankAppTitle: "Банкаа сонгож төлөх",
  bankAppHint: "Утаснаасаа төлж байгаа бол банкаа сонгоно уу — аппликэйшн нээгдэж, төлбөр бэлэн орж ирнэ.",
  orScanQr: "эсвэл QR уншуулах",
